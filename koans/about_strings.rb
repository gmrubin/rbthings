...
EOS
  ...
  # I think that using the shovel operator you can modify the origianl_string's value in memory as opposed to having to assign a pointer to a new point in memory (i.e. using hi += there)
